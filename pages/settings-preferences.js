                            ...
                            <div className="col-xl-9 col-md-8">
                                <div className="row">
                                    <div className="col-xl-12">
                                        <div className="card">
                                            <div className="card-header">
                                                <h4 className="card-title">{t("settings.preferencesTitle")}</h4>
                                            </div>
                                            <div className="card-body">
                                                <form action="">
                                                    <div className="form-row">
                                                        <div className="form-group col-6">
                                                            <label className="me-sm-2">{t("settings.localCurrency")}</label>
                                                        ...
                                                        <div className="form-group col-6">
                                                            <label className="me-sm-2">{t("settings.timeZone")}</label>
                                                            <select className="form-control">
                                                        ...
                                                        <div className="form-group">
                                                            <button className="btn btn-success ps-5 pe-5">  {t("settings.save")}</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    <div className="col-xl-12">
                                        <div className="card">
                                            <div className="card-header">
                                                <h4 className="card-title">{t("settings.notifications")}</h4>
                                            </div>
                                            <div className="card-body">
                                                <form action="">
                                                    <div className="form-row col-6">
                                                        <div className="form-group mb-0">
                                                            <label className="toggle">
                                                                ...
                                                                <span className="toggle-label">{t("settings.notifTransfer")}</span>
                                                            </label>
                                                            <label className="toggle">
                                                                <input className="toggle-checkbox" type="checkbox" />
                                                                <div className="toggle-switch"></div>
                                                                <span className="toggle-label">{t("settings.notifMerchant")}</span>
                                                            </label>
                                                            <label className="toggle">
                                                                <input className="toggle-checkbox" type="checkbox" />
                                                                <div className="toggle-switch"></div>
                                                                <span className="toggle-label">{t("settings.notifRecommendation")}</span>
                                                            </label>
                                                        </div>
